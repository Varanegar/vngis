...
$(document).ready(function () {
    ...
    $("#grid_area").kendoGrid({
        ...
        template: "<button  type='button' class='btn btn-link' onclick=show_detail('#=Id#');><span class='glyphicon glyphicon-zoom-in'></span ></button>"
        }
        , {
            field: "Id",
            title: "&nbsp; &nbsp;",
            attributes: { style: "width:15px;" },
            template: "<button  type='button' class='btn btn-link' onclick='edit_area()';><span class='glyphicon glyphicon-pencil'></span ></button>"
        }
        ]
    });

...
BEGIN
	...
	BEGIN
		...
		FROM	GoodReportCache --join Customer on 
	...
	Select
        ...
        Case @ShowSaleQty WHEN 1 THEN cast(0.0 as float) END as SaleQty ,
        Case @ShowSaleCarton WHEN 1 THEN cast(0.0 as float) END as SaleCarton, 
        Case @ShowRetSaleQty WHEN 1 THEN cast(0.0 as float) END as RetSaleQty ,
        Case @ShowRetSaleCarton WHEN 1 THEN cast(0.0 as float) END as RetSaleCarton, 
        Case @ShowSaleAmount WHEN 1 THEN 0.0 END as SaleAmount ,
        Case @ShowRetSaleAmount WHEN 1 THEN 0.0 END as RetSaleAmount, 
        Case @ShowSaleWeight WHEN 1 THEN cast(0.0 as float) END as SaleWeight ,
        Case @ShowRetSaleWeight WHEN 1 THEN cast(0.0 as float) END as RetSaleWeight, 
        Case @ShowSaleDiscount WHEN 1 THEN 0.0 END as SaleDiscount ,
        Case @ShowRetSaleDiscount WHEN 1 THEN 0.0 END as RetSaleDiscount ,
        Case @ShowPrizeCount WHEN 1 THEN 0 END as SalePrizeCount ,
        Case @ShowPrizeQty WHEN 1 THEN cast(0.0 as float) END as PrizeQty ,
        Case @ShowPrizeCarton WHEN 1 THEN cast(0.0 as float) END as PrizeCarton 
END

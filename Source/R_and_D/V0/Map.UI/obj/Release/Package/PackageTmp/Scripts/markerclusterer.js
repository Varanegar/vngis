...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  * @private
  */
  this.hideSingleGroupMarker_ = options['hideSingleGroupMarker'] || false;
...
/**
* Whether to show group icons for single marker cluseters.
*
* @return {boolean} True to hide icon for group clusters with a single marker.
*/
MarkerClusterer.prototype.getHideSingleGroup = function () {
    return this.hideSingleGroupMarker_;
}
...
Cluster.prototype.addMarker = function(marker) {
  ...
  var hideSingleGroup = this.markerClusterer_.getHideSingleGroup();
  if (hideSingleGroup && this.markers_.length == 0 && marker.getMap() != this.map_) {
...
Cluster.prototype.updateIcon = function () {
    ...
    if (this.markers_.length == 0) {
        ...
        return
    } else if (hideSingleGroup && this.markers_.length < 2) {

...
namespace TrackingMap.Service.Vn.BL
{
    public class VnGoodReportService
    {
        ...
        public List<GoodReportView> LoadGoodReport(GoodReportFilter filter)
        {
            ...
            new SqlParameter("@DealerList", SqlDbType.VarChar, -1) { SqlValue = DbUtility.IsNull((filter.Seller == "" ? "-1" : filter.Seller), "-1").ToString() },
            ...
            new SqlParameter("@GoodsGroupList", SqlDbType.VarChar, -1){SqlValue = DbUtility.IsNull((filter.GoodGroup == "" ?"-1" : filter.GoodGroup ), "-1").ToString()},
            ...
            new SqlParameter("@GoodsList", SqlDbType.VarChar, -1) { SqlValue = DbUtility.IsNull((filter.Good == "" ? "-1" : filter.Good), "-1").ToString() },
